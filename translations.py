TRANSLATIONS = {
    'ru': {
        ...
        'topup_yookassa': '💳 YooKassa',
        'topup_stars': '⭐ Telegram Stars',
        'yookassa_payment_methods': 'Способы оплаты',
        'yookassa_bank_card': '💳 Банковская карта',
        'yookassa_sbp': '🏦 СБП',
        'yookassa_yoo_money': '💰 ЮMoney',
        'yookassa_cash': '💵 Наличные',
        'yookassa_payment_created': '✅ Платеж создан',
        'yookassa_payment_link': '🔗 Ссылка для оплаты',
        'yookassa_payment_status': '📊 Статус платежа',
        'yookassa_payment_success': '✅ Платеж успешно завершен',
        'yookassa_payment_cancelled': '❌ Платеж отменен',
        'yookassa_payment_pending': '⏳ Платеж в обработке',
        'yookassa_payment_failed': '❌ Ошибка платежа',
        'yookassa_enter_amount': '💰 Введите сумму для пополнения (руб.):',
        'yookassa_invalid_amount': '❌ Неверная сумма',
        'yookassa_min_amount': '❌ Минимальная сумма: 1₽',
        'yookassa_max_amount': '❌ Максимальная сумма: 75000₽',
        'yookassa_processing_payment': '⏳ Создаю платеж...',
        'yookassa_payment_error': '❌ Ошибка при создании платежа',
        'yookassa_webhook_error': '❌ Ошибка webhook',
        'yookassa_signature_error': '❌ Ошибка подписи webhook',
        'back': 'Назад',
    ...
    'en': {
        ...
        'topup_yookassa': '💳 YooKassa',
        'topup_stars': '⭐ Telegram Stars',
        'yookassa_payment_methods': 'Payment methods',
        'yookassa_bank_card': '💳 Bank card',
        'yookassa_sbp': '🏦 SBP',
        'yookassa_yoo_money': '💰 YooMoney',
        'yookassa_cash': '💵 Cash',
        'yookassa_payment_created': '✅ Payment created',
        'yookassa_payment_link': '🔗 Payment link',
        'yookassa_payment_status': '📊 Payment status',
        'yookassa_payment_success': '✅ Payment successful',
        'yookassa_payment_cancelled': '❌ Payment cancelled',
        'yookassa_payment_pending': '⏳ Payment pending',
        'yookassa_payment_failed': '❌ Payment error',
        'yookassa_enter_amount': '💰 Enter amount to top up ($):',
        'yookassa_invalid_amount': '❌ Invalid amount',
        'yookassa_min_amount': '❌ Minimum amount: $1',
        'yookassa_max_amount': '❌ Maximum amount: $75000',
        'yookassa_processing_payment': '⏳ Processing payment...',
        'yookassa_payment_error': '❌ Error creating payment',
        'yookassa_webhook_error': '❌ Webhook error',
        'yookassa_signature_error': '❌ Webhook signature error',
        'back': 'Back',
